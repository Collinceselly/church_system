...
SECRET_KEY = 'django-insecure-o_m=xxlif-5_y7v*p0*m@(ddp8$=+#^55&7%i7mkz!@!orok-w'
...
MIDDLEWARE = [
    ...
    'users.middleware.session_timeout.SessionTimeoutMiddleware',
...
LOGIN_URL_MEMBER = '/member/login/'  # URL for members login
LOGIN_URL_STAFF = '/user/login/'   # URL for staff login
LOGOUT_REDIRECT_URL = '/'
...
# preventing creating sessions unless explicitly needed
